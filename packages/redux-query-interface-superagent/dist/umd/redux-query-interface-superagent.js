!(function(t, e) {
  'object' == typeof exports && 'object' == typeof module
    ? (module.exports = e(require('redux-query')))
    : 'function' == typeof define && define.amd
    ? define(['redux-query'], e)
    : 'object' == typeof exports
    ? (exports.ReduxQueryInterfaceSuperagent = e(require('redux-query')))
    : (t.ReduxQueryInterfaceSuperagent = e(t.ReduxQuery));
})(window, function(t) {
  return (function(t) {
    var e = {};
    function r(o) {
    ...
    function(t, e, r) {
      ...
      function y(t) {
        for (var e, r, o = {}, n = t.split('&'), i = 0, s = n.length; i < s; ++i)
          -1 === (r = (e = n[i]).indexOf('='))
            ...
            : (o[decodeURIComponent(e.slice(0, r))] = decodeURIComponent(e.slice(r + 1)));
        return o;
      }
      function m(t) {
        ...
        1223 === e && (e = 204),
          ...
          (this.headers = (function(t) {
            for (var e, r, o, n, i = t.split(/\r?\n/), s = {}, a = 0, u = i.length; a < u; ++a)
              -1 !== (e = (r = i[a]).indexOf(':')) &&
                ((o = r.slice(0, e).toLowerCase()), (n = l(r.slice(e + 1))), (s[o] = n));
            return s;
      ...
      function b(t, e) {
        ...
        (this._query = this._query || []),
          ...
          this.on('end', function() {
            ...
            t
              ? ((t.original = e), (t.response = o), (t.status = o.status), r.callback(t, o))
              : r.callback(null, o);
          });
      }
      function w(t, e, r) {
      ...
      (h.serializeObject = f),
        ...
        (h.parse = { 'application/x-www-form-urlencoded': y, 'application/json': JSON.parse }),
        u(_.prototype),
        (_.prototype._parseBody = function(t) {
          var e = h.parse[this.type];
          return this.req._parser
            ? this.req._parser(this, t)
            : (!e && m(this.type) && (e = h.parse['application/json']),
        ...
        (b.prototype._end = function() {
          ...
          if (
            ...
            var n = this._header['content-type'],
              i = this._serializer || h.serialize[n ? n.split(';')[0] : ''];
            !i && m(n) && (i = h.serialize['application/json']), i && (r = i(r));
          }
        ...
        ['GET', 'POST', 'OPTIONS', 'PATCH', 'PUT', 'DELETE'].forEach(function(t) {
          p.prototype[t.toLowerCase()] = function(e, r) {
            var o = new h.Request(t, e);
    ...
    function(t, e, r) {
      ...
      e.default = function(t, e) {
        var r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
          ...
          u = (function(t, e, r) {
            switch (e) {
              case i.httpMethods.HEAD:
                return n.a.head(t, r);
              case i.httpMethods.GET:
                return n.a.get(t, r);
              case i.httpMethods.POST:
                return n.a.post(t, r);
              case i.httpMethods.PUT:
                return n.a.put(t, r);
              case i.httpMethods.PATCH:
                return n.a.patch(t, r);
              case i.httpMethods.DELETE:
                return n.a.delete(t, r);
              default:
                throw new Error('Unsupported HTTP method: '.concat(e));
            }
          })(t, e, o);
        s && u.set(s), 'include' === a && u.withCredentials();
        return {
          abort: function() {
            return u.abort();
          },
          execute: function(t) {
            return u.end(function(e, r) {
              var o = (r && r.status) || 0,
                n = (r && r.body) || void 0,
                i = (r && r.text) || void 0,
                s = (r && r.header) || void 0;
    ...
    function(t, e, r) {
      ...
      (t.exports = o),
        ...
        (o.prototype.emit = function(t) {
          this._callbacks = this._callbacks || {};
          for (
            var e = new Array(arguments.length - 1), r = this._callbacks['$' + t], o = 1;
            o < arguments.length;
            o++
          )
            e[o - 1] = arguments[o];
    ...
    function(t, e, r) {
      ...
      (t.exports = i),
        ...
        (i.prototype.timeout = function(t) {
          if (!t || 'object' !== o(t))
            return (
              (this._timeout = t), (this._responseTimeout = 0), (this._uploadTimeout = 0), this
            );
          for (var e in t)
      ...
      (i.prototype._shouldRetry = function(t, e) {
        ...
        if (t) {
          if (t.code && -1 !== s.indexOf(t.code)) return !0;
        ...
        (i.prototype._isResponseOK = function(t) {
          return (
            !!t && (this._okCallback ? this._okCallback(t) : t.status >= 200 && t.status < 300)
          );
        }),
        ...
        (i.prototype._auth = function(t, e, r, o) {
          switch (r.type) {
            case 'basic':
